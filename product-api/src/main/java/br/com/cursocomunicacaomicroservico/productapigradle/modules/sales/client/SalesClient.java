package br.com.cursocomunicacaomicroservico.productapigradle.modules.sales.client;
...
public interface SalesClient {
    ...
    Optional<SalesProductResponse> findSalesByProductId(
            @PathVariable Integer productId, @RequestHeader(name = "Authorization") String authorization,
